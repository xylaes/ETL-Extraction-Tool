...
This application automates the conversion of the 'ReportPivotGrid' Excel file 
into a standardized CSV format for import.
...
7. Once finished, a new file named 'transformed_hours_import.csv' will be automatically 
   created in the EXACT SAME FOLDER where your original Excel file was located.
